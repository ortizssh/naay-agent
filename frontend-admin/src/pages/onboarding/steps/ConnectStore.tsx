  ...
  return (
    <>
      ...
      <p className="onboarding-subtitle">
        Ingresa el nombre de tu tienda para iniciar la conexion
      </p>
      ...
      <div className="card" style={{ background: 'var(--color-bg)', marginBottom: '1.5rem' }}>
        <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
          ...
          <div>
            <div style={{ fontWeight: '600', marginBottom: '0.25rem' }}>Conexion segura</div>
            <div style={{ fontSize: '0.9rem', color: 'var(--color-text-secondary)' }}>
              Utilizamos OAuth de Shopify para conectar de forma segura.
              Solo solicitamos permisos de lectura de productos y ordenes.
            </div>
          </div>
        </div>
      </div>

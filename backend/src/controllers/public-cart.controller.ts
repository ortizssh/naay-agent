...
// Get cart details
router.get('/:cartId', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.post('/update', async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    // Update cart
    const updatedCart = await cartService.updateCartLines(shop, cartId, lines);
...
router.post('/remove', async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    // Remove items from cart
    const updatedCart = await cartService.removeFromCart(shop, cartId, lineIds);

...
const PLUGIN_INFO = {
  ...
  changelog: `
        ...
        <ul>
            ...
            <li>Added automatic migration for existing installations</li>
  ...
  installation: `
    ...
    `,
  icons: {
    '1x': 'https://app.heykova.io/assets/plugin-icon-128.png',
    '2x': 'https://app.heykova.io/assets/plugin-icon-256.png',
  },
  banners: {
    low: 'https://app.heykova.io/assets/plugin-banner-772x250.png',
    high: 'https://app.heykova.io/assets/plugin-banner-1544x500.png',
  },
};
